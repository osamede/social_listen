	...
	Users:<br/>
		<table >
		    ...
		    <tr>
				...
				<td><select size="1" name="user1role"><option>Admin</option><option>Normal</option></select></td>
			</tr>
			...
			<tr>
				...
				<td><select size="1" name="user2role"><option>Admin</option><option>Normal</option></select></td>
			</tr>
			...
			<tr>
				...
				<td><select size="1" name="user3role"><option>Admin</option><option>Normal</option></select></td>
			</tr>
