...
public class NightlyStatusReport {
	...
	protected void execute() {
		...
		for(Company company : companies) {
			...
			msg.setSubject(company.getName() + " Open Applicant Activity Report for "+DateFormatUtils.format(startDate.getTime(),"MM/dd/yyyy", TimeZone.getDefault()));
			msg.setText(report);
			reportService.sendMail(msg);
		}
	}
