...
public class ExamDAOTest extends DomainObjectDAOTest<Exam> {
	...
	public void findLatestVersionsByCompanyId() {
		...
		Exam snapshot1 = exam1.createSnapshot();
		...
		List<Exam> latestVersions = examDao.findLatestVersionsByCompanyId(savedCompany.getId());
	...
	public void findLatestActiveVersionsByCompanyId() {
		...
		List<Exam> exams = examDao.findLatestActiveVersionsByCompanyId(savedCompany.getId());
	...
	public void findLatestVersionByArtifactId() {
		...
		Exam exam2 = exam1.createSnapshot();
		examDao.save(exam2);
