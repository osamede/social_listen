...
public class CopyCandidates {
	...
	public static void main(String args[]) throws IOException {
		...
		List<Exam> fromExams = examDao.findLatestActiveVersionsByCompanyId(fromCompanyId);
		List<Exam> toExams   = examDao.findLatestActiveVersionsByCompanyId(toCompanyId);
